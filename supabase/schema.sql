...
CREATE POLICY "personal_images_delete_owner" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'personal-images'::"text") AND ("owner" = "auth"."uid"()) AND ("name" !~~ '%..%'::"text") AND ("name" ~ (('^'::"text" || ("auth"."uid"())::"text") || '/cards/[0-9a-f-]{36}\.jpg$'::"text"))));



CREATE POLICY "personal_images_insert_owner" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'personal-images'::"text") AND ("owner" = "auth"."uid"()) AND ("name" !~~ '%..%'::"text") AND ("name" ~ (('^'::"text" || ("auth"."uid"())::"text") || '/cards/[0-9a-f-]{36}\.jpg$'::"text"))));



CREATE POLICY "personal_images_select_owner" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'personal-images'::"text") AND ("owner" = "auth"."uid"()) AND ("name" !~~ '%..%'::"text") AND ("name" ~ (('^'::"text" || ("auth"."uid"())::"text") || '/cards/[0-9a-f-]{36}\.jpg$'::"text"))));
