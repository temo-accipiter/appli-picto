...
CREATE OR REPLACE FUNCTION "public"."platform_account_preferences_enforce_accessibility"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."platform_account_preferences_enforce_accessibility"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."account_preferences" (
    ...
    "confetti_enabled" boolean DEFAULT false NOT NULL,
    ...
    CONSTRAINT "account_preferences_confetti_reduced_motion_chk" CHECK ((NOT (("reduced_motion" IS TRUE) AND ("confetti_enabled" IS TRUE)))),
...
CREATE OR REPLACE TRIGGER "trg_platform_account_preferences_enforce_accessibility" BEFORE INSERT OR UPDATE ON "public"."account_preferences" FOR EACH ROW EXECUTE FUNCTION "public"."platform_account_preferences_enforce_accessibility"();
...
GRANT ALL ON FUNCTION "public"."platform_account_preferences_enforce_accessibility"() TO "anon";
GRANT ALL ON FUNCTION "public"."platform_account_preferences_enforce_accessibility"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."platform_account_preferences_enforce_accessibility"() TO "service_role";
