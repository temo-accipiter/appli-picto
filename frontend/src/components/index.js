...
export { default as EditionTacheCard } from './taches/edition-tache-card/EditionTacheCard'
export { default as TrainProgressBar } from './taches/train-progress-bar/TrainProgressBar'

export { default as CardRecompense } from './recompenses/card-recompense/CardRecompense'
...
export { default as BaseCard } from './shared/base-card/BaseCard'
